...
main.yml tiedoston kohta "update_cache" määrittää, että apt-työkalun välimuisti pitää päivittää. 
Tätä vastaava komento ansiblen ulkopuolella on "apt-get update".
[Ansible community documentation, ansible.builtin.apt module – Manages apt-packages](https://docs.ansible.com/projects/ansible/latest/collections/ansible/builtin/apt_module.html)

Tämä ei ole välttämätön ominaisuus tälle tehtävälle, mutta yleisesti hyvä käyttää. Haluaisin ainakin aina uusimman version ladattavista paketeista.
